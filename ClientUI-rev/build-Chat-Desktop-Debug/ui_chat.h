...
public:
    ...
    void setupUi(QMainWindow *Chat)
    {
        ...
        stackedWidget->setGeometry(QRect(9, -1, 541, 341));
        page = new QWidget();
        page->setObjectName(QStringLiteral("page"));
        lineEdit_ip = new QLineEdit(page);
        lineEdit_ip->setObjectName(QStringLiteral("lineEdit_ip"));
        lineEdit_ip->setGeometry(QRect(160, 220, 113, 32));
        label_ip = new QLabel(page);
        label_ip->setObjectName(QStringLiteral("label_ip"));
        label_ip->setGeometry(QRect(170, 200, 81, 20));
        ...
        pushButton_chat->setGeometry(QRect(310, 290, 95, 30));
        pushButton_chat->setStyleSheet(QStringLiteral(""));
        label_username = new QLabel(page);
        label_username->setObjectName(QStringLiteral("label_username"));
        label_username->setGeometry(QRect(170, 130, 81, 20));
        ...
        label_port->setGeometry(QRect(170, 270, 81, 20));
        ...
        lineEdit_port->setGeometry(QRect(160, 290, 113, 32));
        ...
        listWidget_users->setGeometry(QRect(10, 10, 141, 251));
        ...
        listWidget_messages->setGeometry(QRect(160, 11, 371, 251));
